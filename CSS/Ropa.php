...
<section class="galeria">
    ...
    $ropa = array(
        array(
            "imagen" => "ropa_perros.jpg",
            "titulo" => "Ropa para Perros",
            "precio" => 15
        ),
        array(
            "imagen" => "ropa_gatos.jpeg",
            "titulo" => "Ropa para Gatos",
            "precio" => 18
        ),
        array(
            "imagen" => "ropa_pajaros.jpeg",
            "titulo" => "Ropa para Aves",
            "precio" => 12
        ),
        array(
            "imagen" => "ropa_conejos.jpeg",
            "titulo" => "Ropa para Conejos",
            "precio" => 20
        )
    );
    ?>
