...
<section class="galeria">
    ...
    $alimentos = array(
        array(
            "imagen" => "alimento_perros.jpg",
            "titulo" => "Alimento para Perros",
            "precio" => 10
        ),
        array(
            "imagen" => "alimento_gatos.jpeg",
            "titulo" => "Alimento para Gatos",
            "precio" => 20
        ),
        array(
            "imagen" => "alimento_aves.jpeg",
            "titulo" => "Alimento para Aves",
            "precio" => 15
        ),
        array(
            "imagen" => "alimento_reptiles.jpeg",
            "titulo" => "Alimento para Reptiles",
            "precio" => 25
        )
    );
    ?>
    ...
    <script>
        ...
        function solicitarDatosCompra() {
            ...
            if (direccion && formaPago) {
                finalizarCompra(direccion, formaPago);
            } else {
        ...
        function finalizarCompra(direccion, formaPago) {
            const nombreEmpresa = "Tienda de Mascotas";
            const direccionCompra = direccion;
            const formaPagoCompra = formaPago;
